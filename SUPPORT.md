...
| Ant | Java, Kotlin | ant test, ant compile | project | Apache Ant 1.10.x; tested with 1.10.17; static import files merge targets, unproved imports keep ant test | [ant](conformance/cli-fixtures/ant) · [ant-imports](conformance/cli-fixtures/ant-imports) · [CliAntConformanceTest.kt](core/src/test/kotlin/com/aspix2k/affected/build/CliAntConformanceTest.kt) · [conformance.yml](.github/workflows/conformance.yml) |
