...
- Skip VFS refresh and external execute-task claims on a proven JetBrains Client frontend so analysis stays on the IDE backend; Gateway install and update stay unclaimed.
