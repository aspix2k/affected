...
Built for multi-module projects and monorepos across 27 supported build ecosystems and 11 JetBrains products. See the [support matrix](docs/SUPPORT.md) for languages, test runners, selection units and evidence.
