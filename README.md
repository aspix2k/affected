...
Built for multi-module projects and monorepos across 26 supported build ecosystems and 11 JetBrains products. See the [support matrix](docs/SUPPORT.md) for languages, test runners, selection units and evidence.
