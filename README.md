...
Built for multi-module projects and monorepos across 20 supported build ecosystems and 11 JetBrains products. See the [support matrix](SUPPORT.md) for languages, test runners, selection units and evidence.
